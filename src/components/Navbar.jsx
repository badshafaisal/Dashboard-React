        ...
        <li className="dropdown"><a href="#" data-toggle="dropdown" className="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="/src/assets/img/user.png" className="user-img-radious-style" /> <span className="d-sm-none d-lg-inline-block" /></a>
          <div className="dropdown-menu dropdown-menu-right pullDown">
            <div className="dropdown-title">Hello Sarah Smith</div>
            {
              user &&(
                <>
                <Link to={"/profile"} className="dropdown-item has-icon"> <i className="far fa-user" /> Profile</Link> 
            <a href="timeline.html" className="dropdown-item has-icon"> <i className="fas fa-bolt" />Activities</a> 
            <a href="#" className="dropdown-item has-icon"> <i className="fas fa-cog" />Settings</a>
            <span onClick={logout} className="dropdown-item has-icon text-danger"> <i className="fas fa-sign-out-alt" />Logout</span>  
                </>
              )
            }
            ...
            <div className="dropdown-divider" />
            {
              !user && (
                <>
                <Link to={"/Login"} className="dropdown-item has-icon"> <i className="far fa-user" /> Login</Link> 
                <Link to={"/signup"} className="dropdown-item has-icon"> <i className="far fa-user" /> Signup</Link> 
                </>
              )
            }
