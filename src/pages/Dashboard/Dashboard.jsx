...
<div className="navbar-bg" />
    <nav className="navbar navbar-expand-lg main-navbar sticky">
      ...
      <ul className="navbar-nav navbar-right">
          ...
          <div className="dropdown-menu dropdown-list dropdown-menu-right pullDown">
            ...
            <div className="dropdown-list-content dropdown-list-message">
              <a href="#" className="dropdown-item"> <span className="dropdown-item-avatar
											text-white"> <img alt="image" src="/src/assets/img/users/user-1.png" className="rounded-circle" />
                  ...
                  <img alt="image" src="/src/assets/img/users/user-2.png" className="rounded-circle" />
                  ...
                  <img alt="image" src="/src/assets/img/users/user-5.png" className="rounded-circle" />
                  ...
                  <img alt="image" src="/src/assets/img/users/user-4.png" className="rounded-circle" />
                  ...
                  <img alt="image" src="/src/assets/img/users/user-3.png" className="rounded-circle" />
        ...
        <li className="dropdown"><a href="#" data-toggle="dropdown" className="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="/src/assets/img/user.png" className="user-img-radious-style" /> <span className="d-sm-none d-lg-inline-block" /></a>
                  ...
                  <div className="row ">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                      <div className="banner-img">
                        <img src="/src/assets/img/banner/1.png" alt />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="card-statistic-4">
                <div className="align-items-center justify-content-between">
                  <div className="row ">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                      <div className="banner-img">
                        <img src="/src/assets/img/banner/2.png" alt />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="card-statistic-4">
                <div className="align-items-center justify-content-between">
                  <div className="row ">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                      <div className="banner-img">
                        <img src="/src/assets/img/banner/3.png" alt />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <table className="table table-striped">
                    <tbody><tr>
                      ...
                      <tr>
                        ...
                        <td className="text-truncate">
                          <ul className="list-unstyled order-list m-b-0 m-b-0">
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-8.png" alt="user" data-toggle="tooltip" title data-original-title="Wildan Ahdian" /></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-9.png" alt="user" data-toggle="tooltip" title data-original-title="John Deo" /></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-10.png" alt="user" data-toggle="tooltip" title data-original-title="Sarah Smith" /></li>
                      ...
                      <tr>
                        ...
                        <td className="text-truncate">
                          <ul className="list-unstyled order-list m-b-0 m-b-0">
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-1.png" alt="user" data-toggle="tooltip" title data-original-title="Wildan Ahdian" /></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-2.png" alt="user" data-toggle="tooltip" title data-original-title="John Deo" /></li>
                      ...
                      <tr>
                        ...
                        <td className="text-truncate">
                          <ul className="list-unstyled order-list m-b-0 m-b-0">
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-3.png" alt="user" data-toggle="tooltip" title data-original-title="Wildan Ahdian" /></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-4.png" alt="user" data-toggle="tooltip" title data-original-title="John Deo" /></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-5.png" alt="user" data-toggle="tooltip" title data-original-title="Sarah Smith" /></li>
                      ...
                      <tr>
                        ...
                        <td className="text-truncate">
                          <ul className="list-unstyled order-list m-b-0 m-b-0">
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-7.png" alt="user" data-toggle="tooltip" title data-original-title="John Deo" /></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-8.png" alt="user" data-toggle="tooltip" title data-original-title="Sarah Smith" /></li>
                            <li className="avatar avatar-sm"><span className="badge badge-primary">+4</span></li>
                          </ul>
                        </td>
                        <td className="align-middle">
                      ...
                      <tr>
                        ...
                        <td className="text-truncate">
                          <ul className="list-unstyled order-list m-b-0 m-b-0">
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-9.png" alt="user" data-toggle="tooltip" title data-original-title="Wildan Ahdian" /></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-10.png" alt="user" data-toggle="tooltip" title data-original-title="John Deo" /></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle" src="/src/assets/img/users/user-2.png" alt="user" data-toggle="tooltip" title data-original-title="Sarah Smith" /></li>
                            <li className="avatar avatar-sm"><span className="badge badge-primary">+2</span></li>
                          </ul>
                        </td>
                        <td className="align-middle">
            ...
            <div className="card">
              ...
              <div className="card-body">
                <div className="support-ticket media pb-1 mb-3">
                  <img src="/src/assets/img/users/user-1.png" className="user-img mr-2" alt />
                ...
                <div className="support-ticket media pb-1 mb-3">
                  <img src="/src/assets/img/users/user-2.png" className="user-img mr-2" alt />
                  <div className="media-body ml-3">
                ...
                <div className="support-ticket media pb-1 mb-3">
                  <img src="/src/assets/img/users/user-3.png" className="user-img mr-2" alt />
                  <div className="media-body ml-3">
                ...
                <div className="support-ticket media pb-1 mb-3">
                  <img src="/src/assets/img/users/user-6.png" className="user-img mr-2" alt />
                  <div className="media-body ml-3">
